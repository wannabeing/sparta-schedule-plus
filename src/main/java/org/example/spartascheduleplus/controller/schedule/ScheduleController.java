...
import org.example.spartascheduleplus.facade.ScheduleFacade;
...
public class ScheduleController {
	...
	public ResponseEntity<SuccessResponseDto<ScheduleDetailResponseDto>> createSchedule(
		...
		return new ResponseEntity<>(
			createSuccessResponseDto(
				...
				"일정 생성에 성공하였습니다",
				scheduleFacade.create(requestDto, loginUser.getId())
			),
			HttpStatus.CREATED
		);
	}
	...
	public ResponseEntity<SuccessResponseDto<ScheduleDetailResponseDto>> updateSchedule(
		...
		return new ResponseEntity<>(
			createSuccessResponseDto(
				...
				httpRequest.getRequestURI(),
				"일정 수정을 완료했습니다.",
				scheduleFacade.update(dto, id, loginUser.getId())
			),
			HttpStatus.OK
		);
	...
	public ResponseEntity<SuccessResponseDto> deleteSchedule(
		...
		// 특정 일정 삭제
		scheduleFacade.delete(id, loginUser.getId());
